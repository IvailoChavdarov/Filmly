        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdInAPI = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_User_Favourites", x => new { x.ApplicationUserID, x.TitleId });
                    table.ForeignKey(
                        name: "FK_User_Favourites_AspNetUsers_ApplicationUserID",
                        column: x => x.ApplicationUserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_User_Favourites_Titles_TitleId",
                        column: x => x.TitleId,
                        principalTable: "Titles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_User_WatchList", x => new { x.ApplicationUserID, x.TitleId });
                    table.ForeignKey(
                        name: "FK_User_WatchList_AspNetUsers_ApplicationUserID",
                        column: x => x.ApplicationUserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_User_WatchList_Titles_TitleId",
                        column: x => x.TitleId,
                        principalTable: "Titles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Titles_Actors_ActorId",
                table: "Titles_Actors",
                column: "ActorId");

            migrationBuilder.CreateIndex(
                name: "IX_User_Favourites_TitleId",
                table: "User_Favourites",
                column: "TitleId");

            migrationBuilder.CreateIndex(
                name: "IX_User_WatchList_TitleId",
