...
namespace Filmly.StaticClasses
{
    public static class Validators
    {
        ...
        public static List<string> BonusRankings { get; } = new List<string>() { "ActionTitles", "FantasyTitles", "ComedyTitles", "FamilyTitles", "HorrorTitles", "RomanceTitles", "DocumentaryTitles", "DramaTitles" };
